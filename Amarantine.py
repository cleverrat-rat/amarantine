#Amarantine 1.10.1 by cleverrat
#Date :2021/8/27
from tkinter import *
...
def setthings():
    ...
    lable = Label(setter,text="     Amarantine 1.10.1    ",fg="SlateBlue1",bg="black",font="微软雅黑")
...
root = tk.Tk()
enres = StringVar() #设置变量
root.title("Amarantine 1.10.1") #设置窗口标题
...
lable.grid(row=0,column=0)#固定位置
lable = Label(root,text="Amarantine 1.10.1 BY CLEVERRAT",fg="gold",bg="black",font="微软雅黑")
lable.grid(row=3,column=0)#固定位置
#-@-@-@-@-@-@-@-@-@-@
#设置输入框
