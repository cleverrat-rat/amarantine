...
def sb():
    sb = tk.Tk()
    sb.title("反馈/建议")
    entry = Entry(sb,font=("微软雅黑",10),width=90)
...
def setthings():
    setter = tk.Tk()
    setter.title("关于")
    setter.minsize(350,100)
    setter.configure(bg='dimgray')
    lable = Label(setter,text="     当前版本:1.09    ",fg="gold",bg="dimgray",font="微软雅黑")
    lable.grid(row=0,column=0)#固定位置
    lable = Label(setter,text="     联系作者:a520823@outlook.com    ",fg="gold",bg="dimgray",font="微软雅黑")
    lable.grid(row=1,column=0)#固定位置
    lable = Label(setter,text="     BY:CLEVERRAT",fg="gold",bg="dimgray",font="微软雅黑")
    lable.grid(row=2,column=0)#固定位置       
def about():
    settere = tk.Tk()
    settere.title("介绍")
    settere.minsize(50,50)
    settere.configure(bg='dimgray')
    lable = Label(settere,text="Amarantine",fg="gold",bg="dimgray",font="微软雅黑")
    lable.grid(row=0,column=0)#固定位置
    lable = Label(settere,text="性别: 男",fg="gold",bg="dimgray",font="微软雅黑")
    lable.grid(row=1,column=0)#固定位置
    lable = Label(settere,text="年龄:12",fg="gold",bg="dimgray",font="微软雅黑")
    lable.grid(row=2,column=0)#固定位置
    lable = Label(settere,text="职业:学生",fg="gold",bg="dimgray",font="微软雅黑")
    lable.grid(row=3,column=0)#固定位置
    lable = Label(settere,text="性格:阳光 开朗",fg="gold",bg="dimgray",font="微软雅黑")
...
def sendmes():
    ...
    AIsay.setProperty('rate', 150)#语速:150
...
root = tk.Tk()
enres = StringVar() #设置变量
root.title("Amarantine 1.09") #设置窗口标题
...
lable.grid(row=0,column=0)#固定位置
lable = Label(root,text="Amarantine 1.09 BY CLEVERRAT",fg="gold",bg="black",font="微软雅黑")
lable.grid(row=3,column=0)#固定位置
#-@-@-@-@-@-@-@-@-@-@
#设置输入框
